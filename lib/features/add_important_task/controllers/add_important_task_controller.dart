import 'package:agen_nusantara/features/add_important_task/repositories/add_important_task_repository.dart';
import 'package:agen_nusantara/shared/services/user_session_service.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class AddImportantTaskController extends GetxController {
  static AddImportantTaskController get to => Get.find();

  late UserSessionService _userSessionService;
  final AddImportantTaskRepository _addImportantTaskRepository =
      AddImportantTaskRepository();
  ...
  Future<void> addTask() async {
    ...
    try {
      ...
      bool success = await _addImportantTaskRepository.addTask(
        username,
        title,
        dueDate,
        description,
